...
- **Langages** : Python, SQL
- **Bases de donnees** : PostgreSQL, MongoDB, DuckDB, SQLite
...
- **Modélisation** : SQL Architect, OLAP, schemas en etoile
...
| # | Projet | Stack | Lien |
|---|--------|-------|------|
| 01 | Analyse des donnees de systemes educatifs | Python, Pandas, Poetry | [Voir le repo](https://github.com/oumaymaselmen/projet-01-analyse-systemes-educatifs) |
| 02 | BDD immobiliere avec SQL | SQL, SQLite, SQL Architect | [Voir le repo](https://github.com/oumaymaselmen/projet-02-sql-bdd-immobilier) |
| 03 | Audit environnement de donnees OLAP | SQL, Power Architect | [Voir le repo](https://github.com/oumaymaselmen/projet-03-audit-environnement-donnees) |
| 04 | Migration de donnees medicales | Python, Docker, PostgreSQL | [Voir le repo](https://github.com/oumaymaselmen/projet-04-migration-donnees-medicales) |
| 05 | Prediction consommation energetique | Scikit-learn, BentoML | [Voir le repo](https://github.com/oumaymaselmen/projet-05-ml-consommation-batiments) |
| 06 | Base de donnees NoSQL Airbnb | MongoDB, Python, Power BI | [Voir le repo](https://github.com/oumaymaselmen/projet-06-nosql-mongodb-airbnb) |
